...
<section id="contact-section" class="py-5 bg-gry font-light">
	<div class="vcontainer">
		<div class="rounded-2.5xl bg-white p-5 mb-2.5">
			...
			<div class="md:pb-5">
				<a href="tel:<?php echo $section['ho_section']['no_tlp'] ?>" class="flex items-center mb-2.5 inline-block" target="_blank">
					...
					<div class="text-2xl md:text-4.5xl px-2.5 text-main" data-aos="fade-left"><?php echo $section['ho_section']['no_tlp'] ?></div>
				</a>
				
				<?php if ($section['ho_section']['email']): ?>
				<a href="mailto:<?php echo $section['ho_section']['email'] ?>" class="flex items-center inline-block" target="_blank">
					<svg class="w-10 h-10 md:w-16 md:h-16" viewBox="0 0 68 69" fill="none" xmlns="http://www.w3.org/2000/svg">
						<g><path d="M19.834 49.0418L48.1673 20.7085M48.1673 20.7085H19.834M48.1673 20.7085V49.0418" stroke="#1E1E1E" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/></g>
					</svg>
					<div class="text-2xl md:text-4.5xl px-2.5 text-main" data-aos="fade-left">inquiries@zhalka.com</div>
				</a>
				<?php endif ?>
		...
		<?php if ($section['ho_section']['company_profile']): ?>
